...
namespace PetAdopt.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241009140226_Table_Adoption")]
    partial class Table_Adoption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetAdopt.Domain.Aggregates.NgoAggregate.VolunteersContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UniqueIdentifier");
            ...
            modelBuilder.Entity("PetAdopt.Domain.AggregatesModels.AdoptionFormAggregate.Adoption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UniqueIdentifier");
            ...
            modelBuilder.Entity("PetAdopt.Domain.Aggregates.NgoAggregate.Ngo", b =>
                {
                    b.Navigation("NgoAddresses");

                    b.Navigation("VolunteersContacts");
                });
